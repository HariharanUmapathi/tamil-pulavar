	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1 col-xs-12">
				...
				<?php } elseif ($topic == "சங்க இலக்கியம்") {
				...
				<?php } elseif ($topic == "தொல்காப்பியம்") {
				?>
				...
				?>
					...
					<i class="glyphicon glyphicon-arrow-right w3-animate-right"></i>&nbsp;&nbsp;குறள் - திருக்குறள்,<br />
				<?php } elseif ($topic == "சிலப்பதிகாரம் மற்றும் மணிமேகலை") {
				?>
