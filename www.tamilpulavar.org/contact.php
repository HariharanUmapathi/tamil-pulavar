			...
			<div class="col-md-10 col-md-offset-1 col-xs-12">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
					<table class="table table-responsive table-striped">
						...
						<tr>
							<td>Name :</td>
							<td><input type="text" name="name" class="form-group" value="" required="required" /></td>
						</tr>

						<tr>
							<td>Email :</td>
							<td><input type="email" name="email" class="form-group" value="" required="required" /></td>
						</tr>

						<tr>
							<td>Select Category:</td>
							<td><select name="category" class="form-group">
						...
						<tr>
							<td>message :</td>
							<td><textarea name="message" class="converters form-group typeahead tt-query" id="cnt" charset="utf-8" autocomplete="off" spellcheck="false" onKeyPress="javascript:convertThis(event)" cols="30" rows="10"></textarea>
								<div id="type"></div>
							</td>
						</tr>
						<tr>
