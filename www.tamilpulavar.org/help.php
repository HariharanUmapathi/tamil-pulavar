...
<body>
   ...
   <div class="container">
      ...
      <h3 class="text-danger glyphicon glyphicon-fire">Tamil word search</h3>
      <div class="embed-responsive embed-responsive-16by9">
         <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/GkBB44GT43I">
         </iframe> <br />
         <hr />
      </div>
      <h3 class="text-danger glyphicon glyphicon-fire">English word search</h3>
      <div class="embed-responsive embed-responsive-16by9">
         <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/AlHfpht66so">
         </iframe><br />
         <hr />
      </div>
      <h3 class="text-danger glyphicon glyphicon-fire">Adding new word</h3>
      <div class="embed-responsive embed-responsive-16by9">
         <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/_P_2P0Hu7iE">
         </iframe>
      </div>
