			...
			<div class="modal-content">
				...
				<div class="modal-body" style="background-color:#e0ffff;">
					<table class='table table-responsive table-striped table-bordered '>
						<tr>
							<td>
								<h5 style='color:#f45016;'>Not present in the dictionary - தேடும் சொல் இந்த அகராதியில் இல்லை</h5>
							</td>
						</tr>
						<tr>
							<td>
								<h5 style='color:#f45016;'><?php echo $val; ?>&nbsp;இச்சொல்லிற்க்கு விளக்கம் தர விரும்பினால் உறுப்பினர் ஆன பின்பு விளக்கம் தருமாறு அன்புடன் கேட்டுக்கொள்கிறோம்</h5>
							</td>
						</tr>
						<tr>
							<td> <button data-toggle='modal' data-target='#squarespaceModal_signup' class='btn bt_hide' id='bt'>Signup</button>
								or <button data-toggle='modal' data-target='#squarespaceModal_login' class='btn bt_hide' id='bt'>Login</button></td>
						</tr>
					</table>
				</div>
			</div>
