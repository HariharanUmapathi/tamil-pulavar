...
<?php
$val	=	$_POST["val"];
$qry	=	mysqli_query($connection,"SELECT `meaning` FROM `kazhakam` WHERE `tword` = '$val'")or die(mysqli_error($connection));
$qry1	=	mysqli_query($connection,"SELECT `meaning` FROM `chennai_tt` WHERE `tword` = '$val'")or die(mysqli_error($connection));
$qry2	=	mysqli_query($connection,"SELECT `meaning` FROM `isaitam` WHERE `tword` = '$val'")or die(mysqli_error($connection));
$qry3	=	mysqli_query($connection,"SELECT `meaning` FROM `david` WHERE `tword` = '$val'")or die(mysqli_error($connection));
$qry4	=	mysqli_query($connection,"SELECT `meaning` FROM `kadir` WHERE `tword` = '$val'")or die(mysqli_error($connection));
$qry5	=	mysqli_query($connection,"SELECT `meaning` FROM `tamtam` WHERE `tword` = '$val'")or die(mysqli_error($connection));
$qry6	=	mysqli_query($connection,"SELECT `meaning` FROM `winslow` WHERE `tword` = '$val'")or die(mysqli_error($connection));
$qry7	=	mysqli_query($connection,"SELECT `meaning` FROM `fabricius` WHERE `tword` = '$val'")or die(mysqli_error($connection));
$fet	=	mysqli_fetch_array($qry);
$fet1	=	mysqli_fetch_array($qry1);
$fet2	=	mysqli_fetch_array($qry2);
$fet3	=	mysqli_fetch_array($qry3);
$fet4	=	mysqli_fetch_array($qry4);
$fet5	=	mysqli_fetch_array($qry5);
$fet6	=	mysqli_fetch_array($qry6);
$fet7	=	mysqli_fetch_array($qry7);
$val  =    $fet['meaning'];
$val1  =    $fet1['meaning'];
$val2 =    $fet2['meaning'];
$val3 =    $fet3['meaning'];
